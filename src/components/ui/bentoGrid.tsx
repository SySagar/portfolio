...
export const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid md:auto-rows-[32rem] grid-cols-1 md:grid-cols-2 justify-items-center lg:grid-cols-3 gap-4 max-w-7xl mx-auto ",
        className
      )}
    >
      {children}
  ...
  return (
    ...
    >
      ...
      <div className="group-hover/bento:translate-x-2 transition duration-200">
        ...
        <div className="font-sans font-normal text-neutral-400 text-sm mt-5 dark:text-neutral-300">
          {description}
        </div>
      </div>
